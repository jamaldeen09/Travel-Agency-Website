  ...
  return (
    <section className="min-h-screen flex justify-center items-center md:px-[5rem] lg:px-[10rem]">
        ...
        <div className={`flex justify-center items-center md:w-[90vw] lg:w-[80vw]`}>
            ...
            <ScrollFadeIn>
            <div className="max-sm:hidden sm:hidden max-md:hidden md:flex lg:flex bg-white rounded-2xl shadow-xl flex flex-col gap-[1rem] cardHoverEffect rotateEffect py-4 px-4 md:mt-[18rem] min-w-[35vw] lg:mt-0 min-w-[20vw]">
